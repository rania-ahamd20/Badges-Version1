...
const CourseDetailsTr = ({route, navigation}: any) => {
  ...
  const fetchDataUsers = async () => {
    await axios
      .get(
        'https://2c7d-92-253-55-73.ngrok-free.app/api/User',
      )
      .then(async result1 => {
        ...
        await axios
          .get(
            'https://2c7d-92-253-55-73.ngrok-free.app/api/CourseTrainee/GetUserCourse/' +
  ...
  const fetchDataAt = async () => {
    await axios
      .get(
        'https://2c7d-92-253-55-73.ngrok-free.app/api/Attendance',
      )
      .then(async result => {
        const id = result.data.find(
          (c: any) => c.courseid == route.params.course.courseid,
        );
