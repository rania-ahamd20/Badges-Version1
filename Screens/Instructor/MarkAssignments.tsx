...
function MarkAssignments({route}:any) {
  ...
  const markAnswer = async (item:any) => {
    try {
      const getAss = await axios.get(
        ` https://3847-92-253-117-43.ngrok-free.app/api/Assignment/GetAssignmentById/${item.assignmentsid}`
      );
  ...
  const GetUser = (id:any) => {
    return axios
      .get(
        ` https://3847-92-253-117-43.ngrok-free.app/api/User/GetUserById/${id}`,
      )
      .then(response => {
