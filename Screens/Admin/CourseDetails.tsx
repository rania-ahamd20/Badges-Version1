...
const CourseDetails = ({ route, navigation }: any) => {
    ...
    const RemoveTr = async (ctid:any) => {
      await axios.delete('https://7df1-2a01-9700-1091-6200-5159-9f77-3e8f-df36.ngrok-free.app/api/CourseTrainee/Delete/'+parseInt(ctid))
      .then(res=>{
        Alert.alert('deleted');
    ...
    const fetchDataUsers = async () => {
        await axios.get('https://7df1-2a01-9700-1091-6200-5159-9f77-3e8f-df36.ngrok-free.app/api/User')
            .then(async (result1) => {
                ...
                await axios.get('https://7df1-2a01-9700-1091-6200-5159-9f77-3e8f-df36.ngrok-free.app/api/CourseTrainee/GetUserCourse/' + parseInt(Course.courseid))
                    .then(async (result) => {
