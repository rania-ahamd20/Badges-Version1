...
const CourseDetails = ({ route, navigation }: any) => {
    ...
    const RemoveTr = async (ctid:any) => {
      await axios.delete('https://d6c8-92-253-55-73.ngrok-free.app/api/CourseTrainee/Delete/'+parseInt(ctid))
      .then(res=>{
        Alert.alert('deleted');
    ...
    const fetchDataUsers = async () => {
        await axios.get('https://d6c8-92-253-55-73.ngrok-free.app/api/User')
            .then(async (result1) => {
                ...
                await axios.get('https://d6c8-92-253-55-73.ngrok-free.app/api/CourseTrainee/GetUserCourse/' + parseInt(Course.courseid))
                    .then(async (result) => {
