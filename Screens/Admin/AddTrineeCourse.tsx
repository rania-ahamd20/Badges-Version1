...
const AddTraineeToCourse = ({route, navigation}: any) => {
  ...
  const getdata = async () => {
    await axios
      ...
      .then(async (courses: any) => {
        ...
        await axios
          .get('https://e803-2a01-9700-1091-6200-2821-f5f8-78b-db71.ngrok-free.app/api/CourseTrainee')
  ...
  const addUsers = async (userid: any) => {
    await axios
      .post(
        'https://e803-2a01-9700-1091-6200-2821-f5f8-78b-db71.ngrok-free.app/api/CourseTrainee/Create',
        {
          mark: 0,
