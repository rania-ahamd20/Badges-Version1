...
function navigation() {
  ...
  const NavigatorInstractor = () => {
    return (
      ...
      >
        <StackIns.Screen name="InstrctorPage" component={InstrctorPage} options={{title:'My Courses'}} />
        <StackIns.Screen name="CourseDetailsInst" component={CourseDetailsInst} options={{title:'Info'}}/>
  ...
  const NavigatorStackForTrainee = () => {
    ...
    return (
      <StackTrainee.Navigator screenOptions={{
        headerTitleAlign: 'center',
        headerStyle: { backgroundColor: Colors.secondary },
        headerTintColor: 'white',
      }}>
  ...
  const NavigatorStackForAdmin = () => {
    return (
      <StackAdmin.Navigator screenOptions={{
        ...
        <StackAdmin.Screen name="AddTraineeToCourse" component={AddTraineeToCourse} />
  ...
  const TabTrainee = ({ route }: any) => {
    return (
      ...
      <Tap.Navigator
        ...
        <Tap.Screen name="Stack" component={NavigatorStackForTrainee} options={{
          tabBarIcon: () => (
        ...
        <Tap.Screen name="submit" component={UploadFileComponent} options={{
          tabBarIcon: () => (
            <Icon name='upload' color={'white'} size={25}></Icon>
          ),
        }} />
  ...
  const Tabadmin = () => {
    return (
      <Tap1.Navigator
        ...
        <Tap1.Screen name="Stack" component={NavigatorStackForAdmin} options={{
          tabBarIcon: () => (
            <Icon name='book' color={'white'} size={25} />
          ),
        }} />
        <Tap1.Screen name="Profile" component={NavigatorManageTrainee} options={{
          tabBarIcon: () => (
            <Icon name='user-circle' color={'white'} size={25}></Icon>
          ),
        }} />
...
<Tap1.Screen
        ...
        <Tap1.Screen name="Settings" component={SettingsScreen} options={{
          tabBarIcon: () => (
            <Icon name='cog' color={'white'} size={25} />
          ),
        }} />
  ...
  const TabInst = () => {
    return (
      <Tap2.Navigator
        ...
        <Tap1.Screen name="Stack" component={NavigatorInstractor} options={{
          tabBarIcon: () => (
            <Icon name='book' color={'white'} size={25} />
          ),
        }} />
  ...
  return (
    userid ? (
      <NavigationContainer>
        <stackall.Navigator initialRouteName={role == 1 ? 'Admin' : role == 2 ? 'Instractor' : role == 3 ? 'Trainee' : 'Login'} screenOptions={{ headerShown: false }}>
